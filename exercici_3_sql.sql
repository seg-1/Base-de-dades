...
SELECT ge.genere_name, COUNT(mo.movie_genere_id) as numero_peliculas FROM tb_genere as ge JOIN tb_movie as mo WHERE ge.genere_id = mo.movie_genere_id 
GROUP BY ge.genere_name ORDER BY numero_peliculas DESC;
